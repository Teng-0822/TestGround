// Configuration
const API_URL = 'https://script.google.com/macros/s/AKfycbwY6ddNz2c9G0CaTIf0Iq7EqOHzz3uDIuhk0X2a8MHo-BihJySrL5arHHV5CoBYRob0/exec';
...
function checkReminders() {
    ...
    reminders.forEach(reminder => {
        if (reminder.reminderTime > 0 && !reminder.alerted && !reminder.completed) {
            ...
            const alertTime = new Date(reminderTime.getTime() - reminder.reminderTime * 60000);
            if (now >= alertTime) {
                const audio = new Audio(alarmSettings.sound === 'custom' ? alarmSettings.customUrl : soundUrls[alarmSettings.sound]);
                audio.play().catch(e => console.log('Audio play failed:', e));
                ...
                if (Notification.permission === 'granted') {
                    ...
                    new Notification('Reminder', { body: typeLabel + reminder.title });
                }
